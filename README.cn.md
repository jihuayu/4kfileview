...
4kfileview fork 自 [kkFileView](https://github.com/kekingcn/kkFileView)。原项目由 kkFileView 社区多年维护，并以 Apache License 2.0 开源。感谢原项目作者和贡献者建立的文档预览能力与生态基础。

这个 fork 版本单独维护，主要原因：

1. 原项目对部分安全漏洞和 bug 的响应节奏较慢，本 fork 会优先跟进安全修复、可复现问题和生产部署反馈。
2. 原项目没有提供 ARM 架构的预编译 Docker 镜像，本 fork 会持续发布 amd64/arm64 可用的 Docker 镜像。
...
地址：[https://github.com/jihuayu/4kfileview](https://github.com/jihuayu/4kfileview)
...
地址：[https://github.com/jihuayu/4kfileview/issues](https://github.com/jihuayu/4kfileview/issues)
...
1. 第一步：clone 项目 https://github.com/jihuayu/4kfileview.git
...
#### 优化内容
1. 更新项目元数据、仓库链接、Issue/安全报告链接与启动脚本提示，统一指向当前维护的 `jihuayu/4kfileview` 仓库
2. 更新演示门户导航与版本记录页面，使其对应 26.2.0 发布线
3. 更新 Docker 基础镜像示例与安全配置示例，使用 v26.2.0 镜像标签
#### 修复问题
...
1. 大文件入队提前处理
1. 新增addTask文件转换入队接口 
1. 采用redis队列，支持4kfileview接口和异构系统入队两种方式
...
https://github.com/jihuayu/4kfileview/issues

### Stars

#### GitHub

[![Stargazers over time](https://starchart.cc/jihuayu/4kfileview.svg)](https://starchart.cc/jihuayu/4kfileview)

### 鸣谢
- 本项目诞生于[凯京集团]，在取得公司高层同意后以 Apache 协议开源出来反哺社区，在此特别感谢凯京集团，以及集团领导[@唐老大](https://github.com/tangshd)的支持、@端木详笑的贡献。
- 本项目已脱离公司由[KK开源社区]维护发展壮大，感谢所有给 4kfileview 提 Issue 、Pr 开发者
- 本项目引入的第三方组件已在 '关于引用' 列表列出，感谢这些项目，让 4kfileview 更出色
